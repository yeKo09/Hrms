...
public class JobSeekerSchoolController {
	...
	public ResponseEntity<?> getAll(){
		return ResponseEntity.ok(this.jobSeekerSchoolService.getAll());
	}
	
	@GetMapping("/getschoolsbycvidordereddesc")
	public ResponseEntity<?> getSchoolsByCvIdDesc(@RequestParam int id){
		return ResponseEntity.ok(this.jobSeekerSchoolService.getSchoolsByCvIdDesc(id));
	}
